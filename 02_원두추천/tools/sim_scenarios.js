...
function tasteTarget(a){ if(a.q2==="고소")return"고소"; if(a.q2==="균형")return"균형"; if(a.q2==="산뜻")return"산뜻한산미"; if(a.q2==="모름"&&a.q5==="부드러움")return"균형"; if(a.q2==="모름"&&a.q5==="개성")return"과실감"; return"균형"; }
...
const S = [
 ...
 ["E 라떼+모름+부드러움+쓴맛회피+디카페인", {q1:"라떼",q2:"모름",q5:"부드러움",q3:"쓴맛회피",q4:"디카페인"}],
